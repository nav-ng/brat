...
def sl_view(request):
    ...
    return render(request, 'sl_view.html', {'shop_name': shop_name})
...
def items_upload(request):
    ...
    return render(request, 'items_upload.html', {'shop_name': shop_name})
...
def item_edit(request, id):
    ...
    return render(request, 'item_edit.html', {'a': a, 'im': im})
...
def posted_items_display(request):
    ...
    return render(request, 'posted_items_display.html', {'mylist': mylist, 's_id': s_id, 'shop_name': shop_name})
...
def send_mail_function(email, auth_token):
    ...
    message = f'click link to verify your account http://127.0.0.1:8000/my_app/verify/{auth_token}'
...
def u_profile(request):
    ...
    return render(request, 'u_profile.html', {'username': username})
...
def sn(request):
    ...
    return render(request, 's_notification.html', {'mylist': mylist})
...
def un(request):
    ...
    for i in a:
        ...
        m_date.append(md)
    mylist = zip(m_content, m_date)
    return render(request, 'u_notification.html', {'mylist': mylist})
